...
This document starts out by describing the basics of syntax before moving on to what is arguably more interesting: descriptions of Lodge's type system in a more theoretical way. If you don't care about syntax and want to learn about the type system, skip to part 2. #review[Text sections red are notes to the author for future revisions.]
